    ...
    if (protocolMsg) {
        ...
        switch (message.messageStubType) {
            ...
            case Types_1.WAMessageStubType.GROUP_CHANGE_ICON:
                const profile = ((_h = message.messageStubParameters) === null || _h === void 0 ? void 0 : _h[0]) ? 'changed' : 'deleted';
                emitGroupUpdate({ imgurl: profile });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_INVITE_LINK:
                const code = (_j = message.messageStubParameters) === null || _j === void 0 ? void 0 : _j[0];
                emitGroupUpdate({ inviteCode: code });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBER_ADD_MODE:
                const memberAddValue = (_k = message.messageStubParameters) === null || _k === void 0 ? void 0 : _k[0];
                emitGroupUpdate({ memberAddMode: memberAddValue === 'all_member_add' });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
                const approvalMode = (_l = message.messageStubParameters) === null || _l === void 0 ? void 0 : _l[0];
                emitGroupUpdate({ joinApprovalMode: approvalMode === 'on' });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD:
                const participant = (_m = message.messageStubParameters) === null || _m === void 0 ? void 0 : _m[0];
                const action = (_o = message.messageStubParameters) === null || _o === void 0 ? void 0 : _o[1];
                const method = (_p = message.messageStubParameters) === null || _p === void 0 ? void 0 : _p[2];
        ...
        if (pollMsg) {
            ...
            const pollEncKey = (_q = pollMsg.messageContextInfo) === null || _q === void 0 ? void 0 : _q.messageSecret;
            try {
